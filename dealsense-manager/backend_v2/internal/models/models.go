...
type AgentConfig struct {
	...
	TTSProvider      TTSProvider      `json:"tts_provider,omitempty" yaml:"tts_provider,omitempty"`
	STTProvider      STTProvider      `json:"stt_provider,omitempty" yaml:"stt_provider,omitempty"`
